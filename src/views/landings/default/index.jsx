  ...
  return (
    <>
      ...
      <LazySection
        sections={[
          {
            importFunc: () => import('@/blocks/other').then((module) => ({ default: module.Other1 })),
            props: { ...other, projects: projects.slice(0, 3) }
          }
        ]}
        offset="200px"
      />
      ...
      <LazySection
        sections={[
          ...
          {
            importFunc: () => import('@/blocks/projectForm').then((module) => ({ default: module.ProjectForm })),
            props: { heading: 'dsf', caption: 'sdf' }
          }
        ]}
        offset="200px"
      />
