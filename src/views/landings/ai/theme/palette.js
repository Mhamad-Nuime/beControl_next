...
export function buildPalette() {
  ...
  const lightPalette = {
    primary: {
      lighter: '#d8f6f7', // AI/primary/90 - primary container / primary fixed
      light: '#99e7eb', // AI/primary/80 - primary fixed dim
      main: '#5bd8de', // AI/primary/40 - primary
      dark: '#4db8bd', // AI/primary/30 - on primary fixed variant
      darker: '#245659' // AI/primary/10 - on primary container / on primary fixed
    },
    secondary: {
