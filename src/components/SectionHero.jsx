...
export default function SectionHero({ heading, captionLine, chip, search = true, offer = false, breadcrumbs, image }) {
  ...
  return (
    ...
    >
      <ContainerWrapper sx={{ minHeight: 400 }}>
        <Stack sx={{ alignItems: 'center', gap: { xs: 1, sm: 1.5 }, marginBlockStart: 10 }}>
          <Box
            sx={{
              position: 'absolute',
              inset: 0,
