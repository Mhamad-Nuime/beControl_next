...
export default function MSlider({ title, imgList }) {
            ...
            <Slider {...settings}>
              {imgList.map((item, index) => (
                ...
                >
                  ...
                  >
                    <Chip
                      label={<img {...item.image} style={{maxWidth : 50, maxHeight: 30}} />}
...
MSlider.propTypes = { title: PropTypes.string, imgList: PropTypes.array };
