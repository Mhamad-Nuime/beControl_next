...
const nextConfig = {
  // Static HTML export: serve the `out` folder with any static host (e.g. Live Server).
  // Use `npm run dev` or `npm run start` if you need API routes like /api/subscribe.
  output: 'export',
  modularizeImports: {
    '@mui/material': {
